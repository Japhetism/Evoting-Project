...
function myfunction(){
	...
	if(text>20|| text<1){
		...
		document.getElementById('field_close').innerHTML = '<br>';
...
function genFields(number_of_posts){
	alert('hi');
// alert(number_of_posts);
	// check if number_of_posts is not null
	// if(number_of_posts !==null && number_of_posts > 0){
		//get all keys
		// alert('hi');
		// var key_array=Object.keys(posts);
		// document.getElementById('dem').innerHTML = 'Post(s)<br>';
		// document.getElementById('dem1').innerHTML = 'Pin(s)<br>';
		// //use loop to break the post array and display each of them in the fields
		// for(var index = 0;index < number_of_posts;index++){
		// 	var currentPost='post'+index;
		// 	var currentPin='pin'+index;
		// 	document.getElementById('dem').innerHTML  += "<input class='form-control' type='text' value="+posts[key_array[index]]+" name="+currentPost+" required><br>";
		// 	document.getElementById('dem1').innerHTML  += "<input class='form-control' type='text' value="+key_array[index]+" name="+currentPin+" required><br>";
		// }
	// }
// 	var text = "";
// 	var text2="";
// 	 var post = document.getElementById('number_of_posts').value;
// 	alert('post');
// 	var key_array=Object.keys(posts);
...
// 			var currentPin='pin'+i;
// //                    text2 += "<input type='text'><br>";
// 			document.getElementById('dem').innerHTML  += "<input class='form-control' type='text' value="+posts[key_array[i]]+" name="+currentPost+" required><br>";
// 			document.getElementById('dem1').innerHTML  += "<input class='form-control' type='text' value="+key_array[i]+" name="+currentPin+" required><br>";
// 		}
