    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			<ul class="nav navbar-nav side-nav sidebar">
				...
				<li>
					<a href="../../japhet/html/maindashboard.php" style="font-weight:bolder;"><i class="fa fa-fw fa-th"></i>My Elections<i style="margin-left:50px;"class="fa fa-caret-down"></i></a>
    ...
    <div class="row">
        <div class="col-md-8">
           ...
           <form method="post">
               <div class="row">
                   <div class="col-md-11">
                       <textarea rows="4" name="post_update" style="max-width: 100%;min-width: 100%;max-height: 80px"><?php echo $news_fetched;?></textarea>
                   </div>
                        <div class="col-md-11">
...
<!-- to get a function to display a comment box -->
