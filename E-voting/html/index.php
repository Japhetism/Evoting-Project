...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!--login section-->
    <section id="login" class="container login-section text-center">
		<!--login section-->
            <div id="login" class="row login" style="display: block">
                        ...
                        <form action="<?php echo htmlspecialchars("#login");?>" method="post">
							...
							<div class="row">
								<div class="col-md-8 col-md-offset-2 input-group">
									...
									<input class="form-control" id="password" type="password" placeholder="Password"  name="lpassword" value="<?php echo $lpassword;?>" required/>
									<span onclick="showPassword('password','eye')" class="input-group-addon after"><i class="fa fa-eye" id="eye" ></i></span>
								</div>
							</div>
                            <div class="row">
