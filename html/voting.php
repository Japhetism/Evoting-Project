                                        ...
                                        <div class="col-xs-12 col-md-4">                                            
                                            <div class="panel panel-default">
                                                ...
                                                <div class="row contestant-details active" id="contestant">
                                                    <div class="col-xs-12">
                                                        <div class="col-xs-2"><img src="../images/female.png" width="40px" height="90%" ></div>
                                                        <div class="col-xs-8" style="text-align: center;">
                                                            <b>Adekagun Damilola A</b> (Adek)
                                                        </div>
                                                        <div class="col-xs-2" style="padding: 0">
                                                            <input id="option" type="radio" name="option">
                                                            <label id="option" class="chosen"></label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="panel-body">
                                                    <div class="row contestant">
                                                        <div class="col-xs-2"><img src="../images/female.png" width="40px" height="90%" ></div>
                                                        <div class="col-xs-8" style="text-align: center;">
                                                            <b>Adekagun Damilola A</b> (Adek)
                                                        </div>
                                                    ...
                                                    <div class="row contestant" style="border: solid 1px #eee;;margin-bottom: 5px">
                                                        <div class="col-md-2"><img src="../images/female.png" width="40px" height="90%" style="margin: 5% -14px 5% -14px;"></div>
                                                        <div class="col-md-8" style="text-align: center;">
                                                            <b>Adekagun Damilola F</b> 
                                                            (Adek)
                                                        </div>
